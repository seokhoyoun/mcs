    ...
    public class RobotSeeder : IDataSeeder
    {
        ...
        public async Task SeedAsync()
        {
            ...
            for (int i = 1; i <= 3; i++)
            {
                ...
                //trayLocation.Position = new Nexus.Core.Domain.Shared.Bases.Position((uint)(100 + i * 10), 100, 0);
            ...
            for (int i = 1; i <= 3; i++)
            {
                ...
                //trayLocation.Position = new Nexus.Core.Domain.Shared.Bases.Position((uint)(200 + i * 10), 100, 0);
                await _locationRepo.AddAsync(trayLocation);
